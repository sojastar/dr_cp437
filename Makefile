...
debug:
	...
	$(CC) $(CFLAGS) $(DEBUG_FLAGS) -o $(DYLIB_PATH)$(SOURCE)$(DYLIB_EXTENSION) $(SOURCE_PATH)$(SOURCE)$(BINDER_OUTPUT_EXTENSION)
...
clean:
	...
	rm -rf $(DYLIB_PATH)$(SOURCE)$(DYLIB_EXTENSION)$(DEBUG_SYM_ENXTENSION)
